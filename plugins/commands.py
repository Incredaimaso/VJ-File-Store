...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 Main Channel', url='https://t.me/piras_official')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/AnimeFantasyG'),
            InlineKeyboardButton('🤖 Anime Channel', url='https://t.me/Animes_Piras')
            ],[
